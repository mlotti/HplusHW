...
# Options
#================================================================================================  
DataSet = "JetHT" # Options = ["SingleMu", "JetHT"]
...
#================================================================================================ 
if DataSet == "SingleMu":
    process.load("HiggsAnalysis.MiniAOD2TTree.TopSystBDTSkim_SingleMu_cfi")
elif DataSet == "JetHT":
    process.load("HiggsAnalysis.MiniAOD2TTree.TopSystBDTSkim_JetHT_cfi")
