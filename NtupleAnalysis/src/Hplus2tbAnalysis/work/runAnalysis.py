...
USAGE:                                                                                                                                                                             
./Hplus2tbAnalysis.py -m <path-to-multicrab-directory> -j <numOfCores> -i <DatasetName>
                                                                                                                                                                                   

Example:                                                                                                                                                                           
./Hplus2tbAnalysis.py -m /multicrab_CMSSW752_Default_07Jan2016/
or
./Hplus2tbAnalysis.py -m multicrab_CMSSW752_Default_07Jan2016/ -j 16
