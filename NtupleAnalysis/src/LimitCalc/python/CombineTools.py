...
lhcAsymptoticOptionsObserved = '-M AsymptoticLimits -v 3 -S 0 --cminDefaultMinimizerStrategy 0 --rAbsAcc 0.0001 --X-rtd FITTER_NEW_CROSSING_ALGO --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND --cminDefaultMinimizerTolerance=0.2 --cminFallbackAlgo "Minuit,0:0.001"' #default
