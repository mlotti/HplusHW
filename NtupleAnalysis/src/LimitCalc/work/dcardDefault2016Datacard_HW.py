...
HeavyMassPoints=[350,1500]
ControlPlotMassPoints = [350,1500]
...
OptionSeparateFakeTtbarFromFakeBackground=False # this flag should be put true for light H+ and to false for heavy H+
...
#                                shapeHistoName=shapeHistoName, histoPath=histoPathGenuineTaus,
#                                datasetType="Embedding",
#                                datasetDefinition="ZJetsToQQ_HT600toInf",
#                                validMassPoints=MassPoints,
