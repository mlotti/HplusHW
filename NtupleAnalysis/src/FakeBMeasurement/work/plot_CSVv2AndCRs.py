...
USAGE:
./plot_CSVv2AndCRs.py -m <pseudo_mcrab_directory> [opts]


EXAMPLES:
./plot_CSVv2AndCRs.py -m FakeBMeasurement_PreSel_3CSVv2M_Pt40Pt40Pt30_SigSel_MVA0p85_InvSel_2CSVv2M_3CSVv2L_MVA0p60to0p85_4BinsEta0p4Eta1p2Eta1p8_180220_061759 --normalizeToOne --dataset Data
./plot_CSVv2AndCRs.py -m FakeBMeasurement_PreSel_3CSVv2M_Pt40Pt40Pt30_SigSel_MVA0p85_InvSel_2CSVv2M_3CSVv2L_MVA0p60to0p85_4BinsEta0p4Eta1p2Eta1p8_180220_061759 --normalizeToOne --dataset EWK


LAST USED:
./plot_CSVv2AndCRs.py -m FakeBMeasurement_AfterPreapproval_MVA0p40_PtBins_130_AbsEtaBins_1p0_1p8_Stat_30May2018 --normalizeToOne --dataset EWK
...
def GetHistoKwargs(h, opts):
    ...
    kwargs = {
        ...
        "cutBox"           : cutBox,
        "cutBoxY"          : cutBoxY,
        "moveLegend"       : {"dx": -0.05, "dy": -0.01, "dh": -0.12},
        }
    ...
    if "bjetspt" in h.lower():
        ...
        # ptBins = [b for b in range(0, 100, 10)] + [b for b in range(100, 500, 20)]
        ptBins = [b for b in range(0, 500, 5)]
        kwargs["rebinX"]  = ptBins
    return kwargs
