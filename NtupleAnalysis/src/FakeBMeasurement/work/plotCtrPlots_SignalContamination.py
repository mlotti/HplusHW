...
Usage:
./plotCtrPlots_SignalContamination.py -m <pseudo_mcrab_directory> [opts]

Examples:
./plotCtrPlots_SignalContamination.py -m FakeBMeasurement_SignalTriggers_NoTrgMatch_StdSelections_TopCut_AllSelections_TopCut10_170725_030408/ -o "" --url
'''
