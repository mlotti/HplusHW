...
def main(opts, signalMass):
    ...
    for opt in optModes:
        ...
        histoPaths1 = [#"H2","Circularity","DPhi_LdgTrijet_SubldgTrijet","Rapidity_LdgTrijet","Rapidity_SubldgTrijet","Rapidity_Tetrajet","SumPt_LdgTrijet_SubldgTrijet","CosTheta_Bjet1TopCM_TrijetLab",
                       "CosTheta_Bjet2TopCM_TrijetLab","CosTheta_Bjet3TopCM_TrijetLab",
                       ...
                       "CosTheta_SubldgTrijetSubldgJetTopCM_TrijetLab","CosTheta_SubldgTrijetBjetTopCM_TrijetLab",
                       #"BJetPair_MaxMass_M","BJetPair_dRMin_Mass",
                       "CosTheta_Bjet1TopCM_Zaxis","CosTheta_Bjet2TopCM_Zaxis","CosTheta_Bjet3TopCM_Zaxis","CosTheta_Bjet1TopCM_TrijetLab"]
...
def SavePlot(plot, saveName, saveDir, saveFormats = ["_gen.pdf"]):
