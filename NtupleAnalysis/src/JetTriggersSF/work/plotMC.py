...
def MCPlot(datasetsMgr, json):
    ...
    #ATHER if json["normalization"]=="normalizeToOne":
    kwargs = {}
    #ATHER    p = plots.MCPlot(datasetsMgr, json["histogram"], normalizeToLumi=float(json["luminosity"]), **kwargs)
    #ATHER  else:
    #ATHER kwargs = {json["normalization"]: True}
