...
void ElectronSelection::bookHistograms(TDirectory* dir) {
  ...
  hElectronPtAll     = fHistoWrapper.makeTH<TH1F>(HistoLevel::kDebug, subdir, "electronPtAll"    , "Electron pT, all;p_{T} (GeV/c)", 50, 0, 500.0);
  hElectronEtaAll    = fHistoWrapper.makeTH<TH1F>(HistoLevel::kDebug, subdir, "electronEtaAll"   , "Electron eta, all;#eta", 50, -2.5, 2.5);
  hElectronRelIsoAll = fHistoWrapper.makeTH<TH1F>(HistoLevel::kDebug, subdir, "electronRelIsoAll", "Electron relative isolation, all;Relative Isolation", 30, 0.0, 300.0);
  hElectronPtPassed  = fHistoWrapper.makeTH<TH1F>(HistoLevel::kDebug, subdir, "electronPtPassed" , "Electron pT, passed;p_{T} (GeV/c)", 50, 0.0, 500.0);
  ...
  hElectronRelIsoPassed = fHistoWrapper.makeTH<TH1F>(HistoLevel::kDebug, subdir, "electronRelIsoPassed", "Electron relative isolation, passed;Relative Isolation", 100, 0.0, 1.0);
  ...
  hIsolPtBefore     = fHistoWrapper.makeTH<TH1F>(HistoLevel::kDebug, subdir, "IsolPtBefore"    , "Electron pT before isolation is applied;p_{T} (GeV/c)", 50, 0.0, 500.0);
  ...
  hIsolRelIsoBefore = fHistoWrapper.makeTH<TH1F>(HistoLevel::kDebug, subdir, "IsolRelIsoBefore", "Electron relative isolation before isolation is applied;Relative Isolation", 30, 0.0, 300.0);
  hIsolPtAfter      = fHistoWrapper.makeTH<TH1F>(HistoLevel::kDebug, subdir, "IsolPtAfter"     , "Electron pT after isolation is applied;p_{T} (GeV/c)", 50, 0.0, 500.0);
  ...
  hIsolRelIsoAfter  = fHistoWrapper.makeTH<TH1F>(HistoLevel::kDebug, subdir, "IsolRelIsoAfter" , "Electron relative isolation after isolation is applied;Relative Isolation", 100, 0.0, 1.0);
}
