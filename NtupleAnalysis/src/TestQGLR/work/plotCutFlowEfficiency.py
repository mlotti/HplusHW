...
USAGE:
./plotCutFlowEfficiency.py -m <pseudo_mcrab_directory> [opts]


EXAMPLES:
./plotCutFlowEfficiency.py -m Hplus2tbAnalysis_StdSelections_TopCut100_AllSelections_TopCut10_171012_011451 --folder jetSelection_ --url

LAST USED:
./plotCutFlowEfficiency.py -m FakeBMeasurement_NewLeptonVeto_PreSel_3bjets40_SigSel_MVA0p85_InvSel_EE2CSVM_MVA0p50to085_180129_133455/ --folder counters/weighted --url --ratio
...
if __name__ == "__main__":
    ...
    if not opts.batchMode:
        raw_input("=== plotCutFlowEfficiency.py: Press any key to quit ROOT ...")
