...
ttjetsStyle       = Style(ROOT.kPlus, ROOT.kMagenta-3)
singleTopStyle    = Style(ROOT.kOpenDiamond, ROOT.kTeal+9)
ttttStyle         = Style(ROOT.kFullStar, ROOT.kRed-9)
wStyle            = Style(ROOT.kFullTriangleDown, ROOT.kOrange+9)
wjetsStyle        = Style(ROOT.kStar, ROOT.kOrange+9)
ttwStyle          = Style(ROOT.kOpenSquare, ROOT.kOrange+7)
ttzStyle          = Style(ROOT.kFullDiamond, ROOT.kViolet+9)
zjetsStyle        = Style(ROOT.kFullCross, ROOT.kGreen-2)
