...
#    "TransverseMass*": [0,20,40,60,80,100,120,140,160,180,200,220,240,260,280,300,350,400,500,600,700,800,900,1000,1500,2000,3500], # MIT rebin (originally ended with 2000,8000])
    "TransverseMass*": [0,20,40,60,80,100,120,140,160,180,200,220,240,260,280,300,320,340,360,380,400,500,600,700,800,900,1000,1500,2000,3500], # rebin for tail fit (changed 300-400 to 20 GeV bins) (originally ended with 2000,8000])
...
#    "shapeTransverseMass": [0,20,40,60,80,100,120,140,160,180,200,220,240,260,280,300,350,400,500,600,700,800,900,1000,1500,2000,3500], # MIT rebin (originally ended with 2000,8000])
    "shapeTransverseMass": [0,20,40,60,80,100,120,140,160,180,200,220,240,260,280,300,320,340,360,380,400,500,600,700,800,900,1000,1500,2000,3500], # rebin for tail fit (changed 300-400 to 20 GeV bins) (originally ended with 2000,8000])
