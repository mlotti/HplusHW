...
void LHCHIGGSLabel(Double_t x,Double_t y,bool Preliminary,Color_t color) 
{
...
void LHCHIGGSLabelOld(Double_t x,Double_t y,bool Preliminary,Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
...
void LHCHIGGSVersion(char* version,Double_t x,Double_t y,Color_t color) 
{
