...
def doPlots(runrange, dataVsMc=True, highPurity=True, dataMcSameTrigger=False):
    ...
    elif runrange == 2: # Prompt-v6 (170722-173198)
        lumi = 385.623
    ...
    l1TriggerName = "SingleTauJet52 OR SingleJet68"
    hltTriggerName = "IsoPFTau35_Trk20"
    ...
    if runrange >= 3:
        hltTriggerName = " MediumIsoPFTau35_Trk20"
    ...
    plotter = Plotter(EfficiencyCalculator(files1), EfficiencyCalculator(files2), legend1, legend2, plotDir, lumi)

    ptbins = [15, 20, 30, 40, 50, 60, 80,
              150
              ]
    ...
    plotter.plotEfficiency(prefix+"Tau1_L1Eff_1JetReco_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="L1 jet reco efficiency")

    denom1 = num1
    denom2 = num2
    num1 = denom1+"&&"+l1SelectionTauVeto
    num2 = denom2+"&&"+l1SelectionTauVeto
    plotter.plotEfficiency(prefix+"Tau1_L1Eff_2TauVeto_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="L1 tau veto efficiency")

    denom1 = num1
    denom2 = num2
    num1 = denom1+"&&"+l1SelectionIsolation
    num2 = denom2+"&&"+l1SelectionIsolation
    plotter.plotEfficiency(prefix+"Tau1_L1Eff_3TauIsolation_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="L1 tau isolation efficiency")
    ...
    plotter.plotEfficiency(prefix+"Tau1_L1Eff_4TauJet_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="L1 tau jet efficiency")

    num1 = denom1+"&&"+l1SelectionCen
    num2 = denom2+"&&"+l1SelectionCen
    plotter.plotEfficiency(prefix+"Tau1_L1Eff_5CenJet_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="L1 central jet efficiency")
    ...
    plotter.plotEfficiency(prefix+"Tau1_L1Eff_6TauCenEtThreshold_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="L1 jet E_{T} threshold efficiency")

    denom1 = offlineSelection1
    denom2 = offlineSelection2
    num1 = denom1+"&&"+l1Selection1
    num2 = denom2+"&&"+l1Selection2
    plotter.plotEfficiency(prefix+"Tau2_L1Eff_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="Level-1 tau efficiency")
    ...
    plotter.plotEfficiency(prefix+"Tau2_L25Eff_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="Level-2.5 tau efficiency")

    denom1 = num1
    denom2 = num2
    num1 = denom1+"&&"+l3Selection1
    num2 = denom2+"&&"+l3Selection2
    plotter.plotEfficiency(prefix+"Tau2_L3Eff_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="Level-3 tau efficiency")
    ...
    plotter.plotEfficiency(prefix+"Tau3_HLT_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="HLT tau efficiency")
    ...
    plotter.plotEfficiency(prefix+"Tau3_L1HLT_PFTauPt", "PFTauPt>>hnumpt", num1, denom1, num2, denom2, opts=optspt, xlabel=xlabel, ylabel="Level-1 + HLT tau efficiency")

    denom1 = And(denom1, offlineTauPt40)
    denom2 = And(denom2, offlineTauPt40)
    num1 = And(num1, offlineTauPt40)
    num2 = And(num2, offlineTauPt40)
    plotter.plotEfficiency(prefix+"Tau4_L1HLT_PFTauEta", "PFTauEta>>heta(4, -2.1, 2.1)", num1, denom1, num2, denom2, xlabel="#tau-jet #eta")
    plotter.plotEfficiency(prefix+"Tau4_L1HLT_PFTauPhi", "PFTauPhi>>heta(4, -3.1416, 3.1416)", num1, denom1, num2, denom2, xlabel="#tau-jet #phi")
...
def getFilesData(runrange, highPurity):
    ...
    return [
        # 160431_167913
        ["data/tteffAnalysis_SingleMu_Run2011A_Tau_May10ReReco_v1_v428_1_V00_09_07/tteffAnalysis-hltpftautight-hpspftau"+tmp+".root",
         "data/tteffAnalysis_SingleMu_Run2011A_Tau_PromptSkim_v4_v428_1_V00_09_07/tteffAnalysis-hltpftautight-hpspftau"+tmp+".root",
         ],
        # 170722_173198, Aug05 is missing!
        ["data/tteffAnalysis_SingleMu_Run2011A_Tau_PromptSkim_v6_v428_1_V00_09_07/tteffAnalysis-hltpftautight-hpspftau"+tmp+".root"],
        # 173236_173692_v428
        ["data/tteffAnalysis_SingleMu_Run2011A_Tau_PromptSkim_v6_v428_1_V00_09_07/tteffAnalysis-hltpftautight-hpspftau"+tmp+".root"]
        ][runrange-1]
...
def getFilesMc(highPurity):
    ...
    if highPurity:
        tmp += "-highpurity"
    return ["data/tteffAnalysis_DYtoTauTau_M-20_TuneP0_7TeV-pythia6-tauola_Summer11-PU_S4_START42_V11-v2_v428_1_V00_09_07/tteffAnalysis-hltpftautight-hpspftau"+tmp+".root"]
...
class EfficiencyCalculator:
    ...
    def getRootHisto(self, varexp, selection, weight=None):
        if weight != None:
            selection = "(%s)*%s" % (selection, weight)
        self.chain.Draw(varexp, selection, "goff")
        h = self.chain.GetHistogram().Clone()
        h.SetDirectory(0)
        return h

class Plotter:
    def __init__(self, calc1, calc2, legend1, legend2, plotDir, lumi):
        self.calc1 = calc1
        self.calc2 = calc2
    ...
    def plotDistribution(self, name, varexp, selection1, selection2=None, weight2=None, xlabel=None):
        if selection2 == None:
    ...
    def plotEfficiency(self, name, varexp, num1, denom1, num2, denom2, weight2=None, xlabel=None, ylabel=None, opts={}):
        ...
        self._common(name, p, xlabel, ylabel, opts_)
        p.save()


    def _common(self, name, plot, xlabel=None, ylabel=None, opts={}):
       plot.createFrame(os.path.join(self.plotDir, name), **opts)
