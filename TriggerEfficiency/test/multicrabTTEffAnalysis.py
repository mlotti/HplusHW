...
import HiggsAnalysis.TriggerEfficiency.tools.multicrabDatasets2011 as multicrabDatasetsTTEff
...
if analysis[:-4] == "MetLeg":
    multicrabDatasetsTTEff.addMetLegSkim_v44_v5(multicrabWorkflows.datasets)
