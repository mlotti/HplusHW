...
TauIsoltrkPtsumVSPtcut = HistoManager(datasets, "signalAnalysis/tau_isoltrk_ptsum_vs_ptcut")
...
#TauIsoltrkPtsumVSPtcut.mergeData()
...
TauIsoltrkPtsumVSPtcut.addStandardTexts()
