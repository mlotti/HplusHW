...
#from HiggsAnalysis.MyEventNTPLMaker.MinimumBias_BeamCommissioning09_SD_AllMinBias_Dec19thSkim_336p3_v1_RAW_RECO import *
...
process.runPFTauProducer = cms.Path(
    ...
    process.pfTauVetoHighEfficiencyShrinkingCone + 
    process.pfTauVetoHighPurityFixedCone + 
    process.pfTauVetoHighPurityFixedConeHighEff + 
    process.pfTauVetoHighPurityShrinkingCone
)
        ...
        PFTaus = cms.VPSet(
            cms.PSet(src =  cms.InputTag("fixedConePFTauProducer"),
                     discriminators = cms.VInputTag(cms.InputTag("fixedConePFTauDiscriminationAgainstElectron"),
                                                    ...
                                                    cms.InputTag("fixedConePFTauDiscriminationAgainstTausHighEfficiency"),
                                                    cms.InputTag("fixedConePFTauDiscriminationAgainstTausHighPurity"))
            ...
            cms.PSet(src = cms.InputTag("fixedConeHighEffPFTauProducer"),
                     discriminators = cms.VInputTag(cms.InputTag("fixedConeHighEffPFTauDiscriminationAgainstElectron"),
                                                    ...
                                                    cms.InputTag("fixedConeHighEffPFTauDiscriminationAgainstTausHighEfficiency"),
                                                    cms.InputTag("fixedConeHighEffPFTauDiscriminationAgainstTausHighPurity"))
            ...
            cms.PSet(src = cms.InputTag("shrinkingConePFTauProducer"),
                     discriminators = cms.VInputTag(cms.InputTag("shrinkingConePFTauDecayModeIndexProducer"),
                                                    ...
                                                    cms.InputTag("shrinkingConePFTauDiscriminationAgainstTausHighEfficiency"),
                                                    cms.InputTag("shrinkingConePFTauDiscriminationAgainstTausHighPurity"))
