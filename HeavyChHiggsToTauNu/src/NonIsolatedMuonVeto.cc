...
// 
//     hMuonPt = histoWrapper.makeTH<TH1F>(HistoWrapper::kVital, myDir, "NonIsolatedMuonPt", "NonIsolatedMuonPt;isolated muon p_{T}, GeV/c;N_{muons} / 5 GeV/c", 80, 0., 400.);
//     hMuonEta = histoWrapper.makeTH<TH1F>(HistoWrapper::kVital, myDir, "NonIsolatedMuonEta", "NonIsolatedMuonEta;isolated muon #eta;N_{muons} / 0.1", 60, -3., 3.);
//     hMuonPt_matchingMCmuon = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonPtmatchingMCmuon", "NonIsolatedMuonPtmatchingMCmuon", 400, 0., 400.);
//     hMuonEta_matchingMCmuon = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonEtamatchingMCmuon", "NonIsolatedMuonEtamatchingMCmuon", 400, -3., 3.);
//     hMuonPt_matchingMCmuonFromW = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonPtmatchingMCmuonFromW", "NonIsolatedMuonPtmatchingMCmuonFromW", 400, 0., 400.);
//     hMuonEta_matchingMCmuonFromW = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonEtamatchingMCmuonFromW", "NonIsolatedMuonEtamatchingMCmuonFromW", 400, -3., 3.);
//     hMuonPt_InnerTrack = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonPt_InnerTrack", "NonIsolatedMuonPt_InnerTrack", 100, 0., 400.);
//     hMuonEta_InnerTrack = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonEta_InnerTrack", "NonIsolatedMuonEta_InnerTrack", 60, -3., 3.);
//     hMuonPt_GlobalTrack = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonPt_GlobalTrack", "NonIsolatedMuonPt_GlobalTrack", 100, 0., 400.);
//     hMuonEta_GlobalTrack = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonEta_GlobalTrack", "NonIsolatedMuonEta_GlobalTrack", 60, -3., 3.);
//     hMuonPt_AfterSelection  = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonPt_AfterSelection", "NonIsolatedMuonPt_AfterSelection", 100, 0., 400.);
//     hMuonEta_AfterSelection = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonEta_AfterSelection", "NonIsolatedMuonEta_AfterSelection", 60, -3., 3.);
//     hMuonPt_InnerTrack_AfterSelection  = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonPt_InnerTrack_AfterSelection", "NonIsolatedMuonPt_InnerTrack_AfterSelection", 100, 0., 400.);
//     hMuonEta_InnerTrack_AfterSelection = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonEta_InnerTrack_AfterSelection", "NonIsolatedMuonEta_InnerTrack_AfterSelection", 60, -3., 3.);
//     hMuonPt_GlobalTrack_AfterSelection  = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonPt_GlobalTrack_AfterSelection", "NonIsolatedMuonPt_GlobalTrack_AfterSelection", 100, 0., 400.);
//     hMuonEta_GlobalTrack_AfterSelection = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedMuonEta_GlobalTrack_AfterSelection", "NonIsolatedMuonEta_GlobalTrack_AfterSelection", 60, -3., 3.);
...
//       hMuonImpactParameter->Fill((*iMuon)->dB()); 
