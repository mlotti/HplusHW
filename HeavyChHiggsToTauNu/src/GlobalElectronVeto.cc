...
namespace HPlus {
    ...
    fEventWeight(eventWeight)
  {
    ...
    hElectronPt  = makeTH<TH1F>(myDir, "GlobalElectronPt", "GlobalElectronPt", 400, 0.0, 400.0);
    hElectronEta = makeTH<TH1F>(myDir, "GlobalElectronEta", "GlobalElectronEta", 400, -3.0, 3.0);
