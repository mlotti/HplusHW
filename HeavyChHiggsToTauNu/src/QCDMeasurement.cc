...
*/
    ...
    hStdAfterNjets = makeTH<TH1F>(myDir, "After_Bjets", "Njets;tau p_{T} bin;N_{events}", myCoefficientBinCount, 0., myCoefficientBinCount);
    ...
    hStdTransverseMassAfterTauID = makeTH<TH1F>(*fs, "TransverseMass_AfterTauID", "TransverseMass_AfterTauID; m_{T}(#tau-jet, E_{T}^{miss}); N_{Events} / 10 GeV/c{^2}", 40, 0.0, 400.0);
