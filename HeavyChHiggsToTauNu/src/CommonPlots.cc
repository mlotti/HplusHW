...
namespace HPlus {
  ...
  void CommonPlots::createHistograms() {
    ...
    // 2D
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DCollinearMinimum,        "ImprovedDeltaPhiCuts2DCollinearMinimum", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{1..3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DCollinearJet1,           "ImprovedDeltaPhiCuts2DJet1Collinear", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{1},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DCollinearJet2,           "ImprovedDeltaPhiCuts2DJet2Collinear", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{2},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DCollinearJet3,           "ImprovedDeltaPhiCuts2DJet3Collinear", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DCollinearJet4,           "ImprovedDeltaPhiCuts2DJet4Collinear", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{4},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    if (fAnalysisType == kSignalAnalysis) {
      ...
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DCollinearJet1,           "ImprovedDeltaPhiCuts2DJet1Collinear", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{1},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DCollinearJet2,           "ImprovedDeltaPhiCuts2DJet2Collinear", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{2},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DCollinearJet3,           "ImprovedDeltaPhiCuts2DJet3Collinear", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    ...
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics,   myCtrlDir,            hCtrlDeltaPhiTauMET, "DeltaPhiTauMET", "#Delta#phi(E_{T}^{miss}, #tau_{h}), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics,   myCtrlDir,            hCtrlMinDeltaPhiTauJet, "MinDeltaPhiTauJet", "min(#Delta#phi(jet_{N}}, #tau_{h})), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics,   myCtrlDir,            hCtrlMaxDeltaPhiTauJet, "MaxDeltaPhiTauJet", "max(#Delta#phi(jet_{N}}, #tau_{h})), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
    // 2D
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DBackToBackMinimum,        "ImprovedDeltaPhiCuts2DBackToBackMinimum", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{1..3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DBackToBackJet1,           "ImprovedDeltaPhiCuts2DJet1BackToBack", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{1},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DBackToBackJet2,           "ImprovedDeltaPhiCuts2DJet2BackToBack", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{2},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DBackToBackJet3,           "ImprovedDeltaPhiCuts2DJet3BackToBack", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DBackToBackJet4,           "ImprovedDeltaPhiCuts2DJet4BackToBack", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{4},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    ...
    if (fAnalysisType == kSignalAnalysis) {
      ...
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausDeltaPhiTauMET, "DeltaPhiTauMET", "#Delta#phi(E_{T}^{miss}, #tau_{h}), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausMinDeltaPhiTauJet, "MinDeltaPhiTauJet", "min(#Delta#phi(jet_{N}}, #tau_{h})), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausMaxDeltaPhiTauJet, "MaxDeltaPhiTauJet", "max(#Delta#phi(jet_{N}}, #tau_{h})), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
      // 2D
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DBackToBackMinimum,        "ImprovedDeltaPhiCuts2DBackToBackMinimum", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{1..3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DBackToBackJet1,           "ImprovedDeltaPhiCuts2DJet1BackToBack", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{1},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DBackToBackJet2,           "ImprovedDeltaPhiCuts2DJet2BackToBack", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{2},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DBackToBackJet3,           "ImprovedDeltaPhiCuts2DJet3BackToBack", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    ...
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics,   myCtrlDir,            hCtrlDeltaPhiTauMETAfterMtSelections, "DeltaPhiTauMETAfterMtSelections", "#Delta#phi(E_{T}^{miss}, #tau_{h}), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics,   myCtrlDir,            hCtrlMinDeltaPhiTauJetAfterMtSelections, "MinDeltaPhiTauJetAfterMtSelections", "min(#Delta#phi(jet_{N}}, #tau_{h})), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics,   myCtrlDir,            hCtrlMaxDeltaPhiTauJetAfterMtSelections, "MaxDeltaPhiTauJetAfterMtSelections", "max(#Delta#phi(jet_{N}}, #tau_{h})), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
    // 2D
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DMinimum,        "ImprovedDeltaPhiCuts2DMinimum", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{1..3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    ...
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DJet2,           "ImprovedDeltaPhiCuts2DJet2", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{2},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlDir,            hCtrlQCDTailKiller2DJet3,           "ImprovedDeltaPhiCuts2DJet3", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    ...
    if (fAnalysisType == kSignalAnalysis) {
      ...
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausDeltaPhiTauMETAfterMtSelections, "DeltaPhiTauMETAfterMtSelections", "#Delta#phi(E_{T}^{miss}, #tau_{h}), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausMinDeltaPhiTauJetAfterMtSelections, "MinDeltaPhiTauJetAfterMtSelections", "min(#Delta#phi(jet_{N}}, #tau_{h})), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kSystematics, myCtrlEWKFakeTausDir, hCtrlEWKFakeTausMaxDeltaPhiTauJetAfterMtSelections, "MaxDeltaPhiTauJetAfterMtSelections", "max(#Delta#phi(jet_{N}}, #tau_{h})), ^{#circ};N_{events}", fPhiBinSettings.bins()/2.0, 0.0, fPhiBinSettings.max());
      // 2D
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DMinimum,        "ImprovedDeltaPhiCuts2DMinimum", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{1..3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DJet1,           "ImprovedDeltaPhiCuts2DJet1", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{1},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DJet2,           "ImprovedDeltaPhiCuts2DJet2", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{2},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DJet3,           "ImprovedDeltaPhiCuts2DJet3", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{3},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
      fSplittedHistogramHandler.createShapeHistogram(HistoWrapper::kVital,   myCtrlEWKFakeTausDir, hCtrlEWKFakeTausQCDTailKiller2DJet4,           "ImprovedDeltaPhiCuts2DJet4", "#Delta#phi(#tau,MET)), ^{o};#Delta#phi(jet_{4},MET), ^{o}", fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max(), fDeltaPhiBinSettings.bins(), fDeltaPhiBinSettings.min(), fDeltaPhiBinSettings.max());
    }
...
//------ Control plot filling
  ...
  void CommonPlots::fillControlPlotsAtCollinearDeltaPhiCuts(const edm::Event& iEvent, const QCDTailKiller::Data& data) {
    ...
    for (int i = 0; i < data.getNConsideredJets(); ++i) {
      ...
      if (i == 0 && myPassStatus) {
        ...
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKiller2DCollinearJet1, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(1));
        if (fFakeTauData.isEWKFakeTauLike() && fAnalysisType == kSignalAnalysis) {
          ...
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKiller2DCollinearJet1, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(1));
        }
        ...
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKiller2DCollinearJet2, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(2));
        if (fFakeTauData.isEWKFakeTauLike() && fAnalysisType == kSignalAnalysis) {
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKillerCollinearJet2, myRadius); // Make control pl
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKiller2DCollinearJet2, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(2));
        }
        ...
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKiller2DCollinearJet3, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(3));
        if (fFakeTauData.isEWKFakeTauLike() && fAnalysisType == kSignalAnalysis) {
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKillerCollinearJet3, myRadius); // Make control pl
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKiller2DCollinearJet3, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(3));
        }
        ...
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKiller2DCollinearJet4, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(4));
        if (fFakeTauData.isEWKFakeTauLike() && fAnalysisType == kSignalAnalysis) {
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKillerCollinearJet4, myRadius); // Make control pl
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKiller2DCollinearJet4, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(4));
        }
      }
  ...
  void CommonPlots::fillControlPlotsAtBackToBackDeltaPhiCuts(const edm::Event& iEvent, const QCDTailKiller::Data& data) {
    ...
    for (int i = 0; i < data.getNConsideredJets(); ++i) {
      ...
      if (i == 0 && myPassStatus) {
        ...
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKiller2DBackToBackJet1, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(1));
        if (fFakeTauData.isEWKFakeTauLike() && fAnalysisType == kSignalAnalysis) {
          ...
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKiller2DBackToBackJet1, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(1));
        }
      } else if (i == 1 && myPassStatus) {
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKillerBackToBackJet2, myRadius); // Make control plot before cut
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKiller2DBackToBackJet2, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(2));
        if (fFakeTauData.isEWKFakeTauLike() && fAnalysisType == kSignalAnalysis) {
          ...
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKiller2DBackToBackJet2, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(2));
        }
      } else if (i == 2 && myPassStatus) {
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKillerBackToBackJet3, myRadius); // Make control plot before cut
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKiller2DBackToBackJet3, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(3));
        if (fFakeTauData.isEWKFakeTauLike() && fAnalysisType == kSignalAnalysis) {
          ...
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKiller2DBackToBackJet3, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(3));
        }
      } else if (i == 3 && myPassStatus) {
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKillerBackToBackJet4, myRadius); // Make control plot before cut
        fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKiller2DBackToBackJet4, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(4));
        if (fFakeTauData.isEWKFakeTauLike() && fAnalysisType == kSignalAnalysis) {
          ...
          fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKiller2DBackToBackJet4, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(4));
        }
      }
  ...
  void CommonPlots::fillControlPlotsAfterAllSelections(const edm::Event& iEvent, double transverseMass) {
    ...
    fSplittedHistogramHandler.fillShapeHistogram(hCtrlQCDTailKiller2DJet4, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(4));
    ...
    if (fFakeTauData.isEWKFakeTauLike() && fAnalysisType == kSignalAnalysis) {
      ...
      fSplittedHistogramHandler.fillShapeHistogram(hCtrlEWKFakeTausQCDTailKiller2DJet4, fQCDTailKillerData.getDeltaPhiTauMET(), fQCDTailKillerData.getDeltaPhiJetMET(4));
    }
