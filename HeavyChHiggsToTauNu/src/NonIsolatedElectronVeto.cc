...
//     fNonIsolatedElectronVetoCounter(eventCounter.addSubCounter("NonIsolatedElectron Selection","NonIsolatedElectronVeto")),
//     fElecSelectionSubCountElectronPresent(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron Present")),
//     fElecSelectionSubCountElectronHasGsfTrkOrTrk(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron has gsfTrack or track")),
//     fElecSelectionSubCountPtCut(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron Pt " )),
//     fElecSelectionSubCountEtaCut(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron Eta")),
//     fElecSelectionSubCountFiducialVolumeCut(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron fiducial volume")),
//     fElecSelectionSubCountMatchingMCelectron(eventCounter.addSubCounter("NonIsolatedElectron Selection","Electron matching MC electron")),
//     fElecSelectionSubCountMatchingMCelectronFromW(eventCounter.addSubCounter("NonIsolatedElectron Selection","Electron matching MC electron From W")),
//     fElecSelectionSubCountElectronSelection(eventCounter.addSubCounter("NonIsolatedElectron Selection", fElecSelection)),
//     fElecSelectionSubCountNLostHitsInTrkerCut(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron Num of Lost Hits In Trker")),
//     fElecSelectionSubCountmyElectronDeltaCotThetaCut(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron Delta Cot(Theta)")),
//     fElecSelectionSubCountmyElectronDistanceCut(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron Distance (r-phi)")),
//     fElecSelectionSubCountTransvImpactParCut(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron Transverse Impact Parameter")),
//     fElecSelectionSubCountDeltaRFromGlobalOrTrkerMuonCut(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron DeltaR From Global OrTrker Muon")),
//     fElecSelectionSubCountRelIsolationR03Cut(eventCounter.addSubCounter("NonIsolatedElectron Selection", "Electron RelIsolationR03")),
//     fElecIDSubCountAllElectronCandidates(eventCounter.addSubCounter("NonIsolatedElectron ID", "All Electron Candidates")),
//     fElecIDSubCountElecIDLoose(eventCounter.addSubCounter("NonIsolatedElectron ID", "eidLoose")),
//     fElecIDSubCountElecIDRobustLoose(eventCounter.addSubCounter("NonIsolatedElectron ID", "eidRobustLoose")),
//     fElecIDSubCountElecIDTight(eventCounter.addSubCounter("NonIsolatedElectron ID", "eidTight")),
//     fElecIDSubCountElecIDRobustTight(eventCounter.addSubCounter("NonIsolatedElectron ID", "eidRobustTight")),
//     fElecIDSubCountElecIDRobustHighEnergy(eventCounter.addSubCounter("NonIsolatedElectron ID", "eidRobustHighEnergy")),
//     fElecIDSubCountSimpleEleId95relIso(eventCounter.addSubCounter("NonIsolatedElectron ID", "SimpleEleId95relIso")),
//     fElecIDSubCountSimpleEleId90relIso(eventCounter.addSubCounter("NonIsolatedElectron ID", "SimpleEleId90relIso")),
...
//     hElectronPt_matchingMCelectron  = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronPt_matchingMCelectron", "NonIsolatedElectronPt_matchingMCelectron", 400, 0.0, 400.0);
//     hElectronEta_matchingMCelectron = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronEta_matchingMCelectron", "NonIsolatedElectronEta_matchingMCelectron", 400, -3.0, 3.0);
//     hElectronPt_matchingMCelectronFromW  = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronPt_matchingMCelectronFromW", "NonIsolatedElectronPt_matchingMCelectronFromW", 400, 0.0, 400.0);
//     hElectronEta_matchingMCelectronFromW = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronEta_matchingMCelectronFromW", "NonIsolatedElectronEta_matchingMCelectronFromW", 400, -3.0, 3.0);
//     hElectronPt_gsfTrack  = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronPt_gsfTrack", "NonIsolatedElectronPt_gsfTrack", 100, 0.0, 200.0);
//     hElectronEta_gsfTrack = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronEta_gsfTrack", "NonIsolatedElectronEta_gsfTrack", 60, -3.0, 3.0);
//     hElectronEta_superCluster = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronEta_superCluster", "NonIsolatedElectronEta_superCluster", 60, -3.0, 3.0);
//     hElectronPt_AfterSelection = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronPt_AfterSelection", "NonIsolatedElectronPt_AfterSelection", 100, 0.0, 200.0);
//     hElectronEta_AfterSelection = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronPt_AfterSelection", "NonIsolatedElectronEta_AfterSelection", 60, -3.0, 3.0);
//     hElectronPt_gsfTrack_AfterSelection = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronPt_gsfTrack_AfterSelection", "NonIsolatedElectronPt_gsfTrack_AfterSelection", 100, 0.0, 200.0);
//     hElectronEta_gsfTrack_AfterSelection = histoWrapper.makeTH<TH1F>(HistoWrapper::kInformative, myDir, "NonIsolatedElectronPt_gsfTrack_AfterSelection", "NonIsolatedElectronPt_gsTrack_AfterSelection", 60, -3.0, 3.0);
...
//   }
// 
//   NonIsolatedElectronVeto::Data NonIsolatedElectronVeto::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
//     ensureAnalyzeAllowed(iEvent);
//     return privateAnalyze(iEvent, iSetup);
//   }
// 
//   NonIsolatedElectronVeto::Data NonIsolatedElectronVeto::privateAnalyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
//     // Reset data variables
//     fSelectedElectronPt = -1.0;
//     fSelectedElectronEta = -999.99;
//     fSelectedElectrons.clear();
//     fElectronsWithGSFTrk.clear();
//     
//     if(!bUseCustomElectronID) return Data(this, ElectronSelection(iEvent,iSetup));
//     else{
//       throw cms::Exception("Error") << "The ElectronSelection \"" << fElecSelection << "\" cannot be called with the function:\n\"NonIsolatedElectronVeto::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)\"\nFor this selection you must call the function:\n\"NonIsolatedElectronVeto::analyzeCustomElecID(const edm::Event& iEvent, const edm::EventSetup& iSetup)\"" << std::endl;      
...
//     else{
//       throw cms::Exception("Error") << "The ElectronSelection \"" << fElecSelection << "\" cannot be called with the function:\n\"NonIsolatedElectronVeto::analyzeCustomElecID(const edm::Event& iEvent, const edm::EventSetup& iSetup)\"\nFor this selection you must call the function:\n\"NonIsolatedElectronVeto::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)\"" << std::endl;
//       return Data(this, false);
//     }
//   }
// 
//   bool NonIsolatedElectronVeto::ElectronSelection(const edm::Event& iEvent, const edm::EventSetup& iSetup){
...
//       if( fElecIDSimpleEleId95relIso == 5) increment(fElecIDSubCountSimpleEleId95relIso);
//       if( fElecIDSimpleEleId90relIso == 5) increment(fElecIDSubCountSimpleEleId90relIso);
//       if( fElecIDSimpleEleId85relIso == 5) increment(fElecIDSubCountSimpleEleId85relIso);
//       if( fElecIDSimpleEleId80relIso == 5) increment(fElecIDSubCountSimpleEleId80relIso);
//       if( fElecIDSimpleEleId70relIso == 5) increment(fElecIDSubCountSimpleEleId70relIso);
//       if( fElecIDSimpleEleId60relIso == 5) increment(fElecIDSubCountSimpleEleId60relIso);
// 
...
// 
//       // Fill Vector of NonIsolatedElectrons after ensuring GSF track and Fiducial volume cuts
//       fElectronsWithGSFTrk.push_back((*iElectron));
// 
//       bElecHasGsfTrkOrTrk = true;   
...
//       else if( (bUseSimpleEleId95relIsoID) && (fElecIDSimpleEleId95relIso == 5) ) bPassedElecID = true;
//       else if( (bUseSimpleEleId90relIsoID) && (fElecIDSimpleEleId90relIso == 5) ) bPassedElecID = true;
//       else if( (bUseSimpleEleId85relIsoID) && (fElecIDSimpleEleId85relIso == 5) ) bPassedElecID = true;
//       else if( (bUseSimpleEleId80relIsoID) && (fElecIDSimpleEleId80relIso == 5) ) bPassedElecID = true;
//       else if( (bUseSimpleEleId70relIsoID) && (fElecIDSimpleEleId70relIso == 5) ) bPassedElecID = true;
//       else if( (bUseSimpleEleId60relIsoID) && (fElecIDSimpleEleId60relIso == 5) ) bPassedElecID = true; 
//       else{
...
//     return true;
//     
//   }//eof: bool NonIsolatedElectronVeto::ElectronSelection(const edm::Event& iEvent, const edm::EventSetup& iSetup){
// 
//   bool NonIsolatedElectronVeto::CustomElectronSelection(const edm::Event& iEvent, const edm::EventSetup& iSetup){
//     
//     // Create and attach handle to Electron Collection
...
// 
//     // Otherwise increment counter and return true.
//     else increment(fNonIsolatedElectronVetoCounter);
//     return true;
//     
//   }//eof: bool NonIsolatedElectronVeto::CustomElectronSelection(const edm::Event& iEvent, const edm::EventSetup& iSetup){
// 
// }//eof: namespace HPlus {
