  ...
  public:
    ...
    WrappedTH1* makeTH(HistoLevel level, TFileDirectory& fd, const Arg1& a1, const Arg2& a2, const Arg3& a3,
      ...
      if (level <= fAmbientLevel) {
        ...
        histo->Sumw2();
        fAllTH1Histos.push_back(WrappedTH1(fEventWeight, histo, true));
      } else {
        // Histogram is suppressed
        TH1* histo = 0;
        fAllTH1Histos.push_back(WrappedTH1(fEventWeight, histo, false));
      }
    ...
    WrappedTH2* makeTH(HistoLevel level, TFileDirectory& fd, const Arg1& a1, const Arg2& a2, const Arg3& a3,
      ...
      if (level <= fAmbientLevel) {
        ...
        histo->Sumw2();
        fAllTH2Histos.push_back(WrappedTH2(fEventWeight, histo, true));
      } else {
        // Histogram is suppressed
        TH2* histo = 0;
        fAllTH2Histos.push_back(WrappedTH2(fEventWeight, histo, false));
      }
