...
class CaloRecoTauDiscriminationByTauPolarization : public CaloTauDiscriminationProducerBase  {
    public:
	explicit CaloRecoTauDiscriminationByTauPolarization(const ParameterSet& iConfig):CaloTauDiscriminationProducerBase(iConfig) {
...
void CaloRecoTauDiscriminationByTauPolarization::beginEvent(const Event& event, const EventSetup& eventSetup){}

double CaloRecoTauDiscriminationByTauPolarization::discriminate(const CaloTauRef& tau){
