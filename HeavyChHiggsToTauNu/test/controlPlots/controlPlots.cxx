...
void Manager::makePlot(double xmin, double xmax, double ymin, double ymax, double delta, string xtitle, string ytitle, double br, double mass, bool logy) {
  ...
  //TLatex* tex = new TLatex(0.62,0.945,"CMS");
  tex->SetNDC();
  tex->SetTextFont(43);
  tex->SetTextSize(27);
  tex->SetLineWidth(2);
...
int main() {
  ...
  */
  ...
  /*
  hSelectionFlowFrame->GetXaxis()->SetBinLabel(1, "#tau_{h}+#geq 3j");
  hSelectionFlowFrame->GetXaxis()->SetBinLabel(2, "E_{T}^{miss} > 50");
  hSelectionFlowFrame->GetXaxis()->SetBinLabel(3, "#geq 1 btags");
  */
  ...
  mySelectionFlow->makePlot(0, nbins, 1, 6e3, 0.3, "", "Events", myBr, myMassPoint, !false);
  /*
