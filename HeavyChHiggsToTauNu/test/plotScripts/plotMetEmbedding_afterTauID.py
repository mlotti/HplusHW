...
h = plots.DataMCPlot(datasets, "signalAnalysisTauSelectionHPSTightTauBased/TauEmbeddingAnalysis_afterTauId_embeddingMet")
...
h.createFrame("MetEmbedding_afterTauId", ymin=0.001, ymaxfactor=2)
...
h.stackMCHistograms()
h.addMCUncertainty()
h.createFrameFraction("MetEmbedding_afterTauId2", ymin=0.001, ymaxfactor=2)
