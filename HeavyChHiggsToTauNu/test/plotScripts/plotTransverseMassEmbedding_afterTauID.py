...
h = plots.DataMCPlot(datasets, "signalAnalysisTauSelectionHPSTightTauBased/TauEmbeddingAnalysis_afterTauId_TransverseMass")
...
h.createFrame("MtEmbedding_afterTauId")
...
h.stackMCHistograms()
h.addMCUncertainty()
h.createFrameFraction("MtEmbedding_afterTauId2")
