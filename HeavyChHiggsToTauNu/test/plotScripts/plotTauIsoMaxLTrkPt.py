...
TauIsoMaxlTrkPt = HistoManager(datasets, "signalAnalysis/tau_isomaxltrk_pt")
...
#TauIsoMaxlTrkPt.removeDatasets(["QCD_Pt15_pythia6", "QCD_Pt15_pythia8", "QCD_Pt30",
...
#TauIsoMaxlTrkPt.mergeDataDatasets()

### Example how to set the luminosity of a data dataset
#TauIsoMaxlTrkPt.getDataset("Data").setLuminosity(5)
...
TauIsoMaxlTrkPt.addLuminosityText() ### need to comment out if normalising to unity 
