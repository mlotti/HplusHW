...
h = plots.DataMCPlot(datasets, "signalAnalysisTauSelectionHPSTightTauBased/TauEmbeddingAnalysis_afterTauId_DeltaPhi")
...
h.createFrame("DeltaPhiEmbedding_afterTauId")
...
h.stackMCHistograms()
h.addMCUncertainty()
h.createFrameFraction("DeltaPhiEmbedding_afterTauId2")
