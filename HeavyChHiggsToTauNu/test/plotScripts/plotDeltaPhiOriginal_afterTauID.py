...
h = plots.DataMCPlot(datasets, "signalAnalysisTauSelectionHPSTightTauBased/TauEmbeddingAnalysis_afterTauId_DeltaPhiOriginal")
...
h.createFrame("DeltaPhiOriginal_afterTauId")
h.frame.GetXaxis().SetTitle("#Delta#phi(#tau jet, MET)")
...
h.stackMCHistograms()
h.addMCUncertainty()
h.createFrameFraction("DeltaPhiOriginal_afterTauId2")
