...
h = plots.DataMCPlot(datasets, "signalAnalysisTauSelectionHPSTightTauBased/TauEmbeddingAnalysis_afterTauId_originalMet")
...
h.createFrame("MetOriginal_afterTauId", ymin=0.001, ymaxfactor=2)
h.frame.GetXaxis().SetTitle("MET (GeV)")
h.frame.GetYaxis().SetTitle("Events / 5 GeV")
...
h.stackMCHistograms()
h.addMCUncertainty()
h.createFrameFraction("MetOriginal_afterTauId2", ymin=0.001, ymaxfactor=2)
