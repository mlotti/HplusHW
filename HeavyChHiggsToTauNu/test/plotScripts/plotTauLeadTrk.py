...
#TauLeadTrk.removeDatasets(["QCD_Pt15_pythia6", "QCD_Pt15_pythia8", "QCD_Pt30",
...
#TauLeadTrk.mergeDataDatasets()

### Example how to set the luminosity of a data dataset
#TauLeadTrk.getDataset("Data").setLuminosity(5)
...
# TauLeadTrk.mergeDatasets("QCD", ["QCD_Pt30to50", "QCD_Pt50to80", "QCD_Pt80to120", "QCD_Pt120to170", "QCD_Pt170to230", "QCD_Pt230to300"]) #uncomment me

### Example how to remove given datasets
#TauLeadTrk.removeDatasets(["QCD", "TTbar"])
#TauLeadTrk.removeDatasets(["TTToHpmToTauNu_M90", "QCD"])
...
TauLeadTrk.addLuminosityText() ### need to comment out if normalising to unity 
