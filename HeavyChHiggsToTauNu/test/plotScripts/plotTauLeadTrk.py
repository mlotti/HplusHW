...
datasets = getDatasetsFromMulticrabCfg(counters="signalAnalysisCounters/weighted") ## uncomment me
...
TauLeadTrk = HistoManager(datasets, "signalAnalysis/tau_leadtrk_pt")
...
TauLeadTrk.normalizeMCToLuminosity(2.89390989)
ylabel = "Events"
