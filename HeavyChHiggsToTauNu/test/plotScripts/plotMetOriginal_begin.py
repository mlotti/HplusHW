...
h = plots.DataMCPlot(datasets, "signalAnalysisTauSelectionHPSTightTauBased/TauEmbeddingAnalysis_begin_originalMet")
...
h.createFrame("MetOriginal_begin", ymin=0.001, ymaxfactor=2)
...
h.stackMCHistograms()
h.addMCUncertainty()
h.createFrameFraction("MetOriginal_begin2", ymin=0.001, ymaxfactor=2)
