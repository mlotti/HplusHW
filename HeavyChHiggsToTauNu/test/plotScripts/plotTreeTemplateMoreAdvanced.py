...
JetsEta = "jets_p4.Eta()";
NFwdJets = "Sum$(abs(jets_p4.Eta()) >= 1.5)";
...
#    "alphaT": "alphaT >> alphaT(40, 0.0, 2.0)", 
#    "mT": "%s >> mT(30, 0.0, 600.0)" % (Mt),
#    "DeltaPhi": "%s >> mT(45, 0.0, 180.0)" % (DeltaPhi),
#    "JetsEta": "%s >> JetsEta(25, 0.0, 2.5)" % (JetsEta),
#    "NFwdJets": "%s >> NFwdJets(10, -0.5, 9.5)" % (NFwdJets),
    "Rtau": "%s >> Rtau(10, 0.00, 1.05)" % (Rtau)
    }
