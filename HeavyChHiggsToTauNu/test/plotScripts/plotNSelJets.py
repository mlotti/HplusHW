...
#NSelJets.removeDatasets(["QCD_Pt15_pythia6", "QCD_Pt15_pythia8", "QCD_Pt30",
...
#NSelJets.mergeDataDatasets()

### Example how to set the luminosity of a data dataset
#NSelJets.getDataset("Data").setLuminosity(5)
...
#NSelJets.normalizeMCByCrossSection()
...
NSelJets.normalizeMCToLuminosity(10)
ylabel = "Events"
...
# NSelJets.mergeDatasets("QCD", ["QCD_Pt30to50", "QCD_Pt50to80", "QCD_Pt80to120", "QCD_Pt120to170", "QCD_Pt170to230", "QCD_Pt230to300"]) #uncomment me
...
(canvas, frame) = NSelJets.createCanvasFrame("NSelJets", ymin=0.01, ymax=None, xmin=0.0, xmax=12.0)
...
NSelJets.addLuminosityText() ### need to comment out if normalising to unity 
