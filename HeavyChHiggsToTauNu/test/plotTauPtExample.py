...
legendLabels = {
    ...
    "QCD_Pt170to300_Fall10":      "QCD, 170 < #hat{p}_T < 230",}
...
#    "TTToHplusBWB_M120",
    ...
    "QCD_Pt80", "QCD_Pt170",
    "QCD_Pt30to50", "QCD_Pt50to80", "QCD_Pt80to120",
...
for subCounterName in eventCounter.getSubCounterNames():
    print "============================================================"
    print "Subcounter %s (%s)" % (subCounterName, eventCounter.getNormalizationString())
