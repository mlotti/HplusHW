...
process.runPFTauProducer = cms.Path(
    process.pfTauVetoHighEfficiencyFixedCone + process.pfTauVetoHighEfficiencyFixedConeHighEff + process.pfTauVetoHighEfficiencyShrinkingCone +  process.pfTauVetoHighPurityFixedCone + process.pfTauVetoHighPurityFixedConeHighEff + process.pfTauVetoHighPurityShrinkingCone
)
#
