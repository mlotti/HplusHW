...
tauPts = datasets.getHistoSet("signalAnalysis/NumberOfSelectedJets")
...
(canvas, frame) = tauPts.createCanvasFrame("numberOfJets")
(canvas, frame) = tauPts.createCanvasFrame("numberOfJets", ymin=0.01, ymax=20000) # for logy
