...
class QCDInvertedShape:
    def __init__(self, shape, moduleInfoString, normFactors, optionPrintPurityByBins=False):
        ...
        self._doCalculate(shape, moduleInfoString, normFactors, optionPrintPurityByBins)
    ...
    def _doCalculate(self, shape, moduleInfoString, normFactors, optionPrintPurityByBins):
