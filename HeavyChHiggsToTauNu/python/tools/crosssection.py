...
def hplusTauNu2CrossSection(mass, tanbeta):
    (tHBR, HtaunuBR) = hplusTauNuBRs(mass, tanbeta)

    return ttCrossSection * tHBR*tHBR * HtaunuBR*HtaunuBR
...
def printHplusCrossSections():
    ...
    for tanbeta in [10, 20, 30, 40]:
        ...
        for mass in [90, 100, 120, 140, 150, 155, 160]:
            ...
            print "%10d | %10f | %13f | %24f | %27f |" % (mass, BR[0], BR[1], hplusTauNuCrossSection(mass, tanbeta), hplusTauNu2CrossSection(mass, tanbeta))
