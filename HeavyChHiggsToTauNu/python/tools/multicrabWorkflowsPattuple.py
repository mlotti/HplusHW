...
def addPattuple_44X(version, datasets, updateDefinitions, skim=None):
    ...
    defaultDefinitions = {
        ...
        "HplusTB_M180_Fall11":       TaskDefMC(njobsIn=5, njobsOut=2),
        "HplusTB_M190_Fall11":       TaskDefMC(njobsIn=5, njobsOut=2),
        "HplusTB_M200_Fall11":       TaskDefMC(njobsIn=5, njobsOut=2),
        "HplusTB_M220_Fall11":       TaskDefMC(njobsIn=5, njobsOut=2),
        "HplusTB_M250_Fall11":       TaskDefMC(njobsIn=5, njobsOut=2),
        "HplusTB_M300_Fall11":       TaskDefMC(njobsIn=5, njobsOut=2),
        ...
        "W3Jets_TuneZ2_v2_Fall11":          TaskDefMC(njobsIn=100, njobsOut=10, args={"wjetsWeighting": 1, "wjetBin": 3}),
