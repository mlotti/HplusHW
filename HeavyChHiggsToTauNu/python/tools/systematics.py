...
_dataDrivenCtrlPlotBinning = {
    ...
    "CollinearTailKillerMinimum*": [0,20,40,60,80,100,120,140,160,180,200,220,240,260],
    "BackToBackTailKillerMinimum*": [0,20,40,60,80,100,120,140,160,180,200,220,240,260],
    ...
    "SelectedTau_Rtau_FullRange_AfterMtSelections": [0.0, 0.05, 0.1, 0.15,0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.55,0.6,0.65,0.70,0.75,0.80,0.85,0.90,0.95,1.00],
