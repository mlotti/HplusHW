# Generated on Mon Mar  4 15:25:54 2013
    ...
    dataParameters = cms.PSet(
        ...
        runs_190456_208686 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.828025477707, 0.0355326423966),
                triggerBin(65.0, 0.842696629213, 0.0484302104014),
                triggerBin(70.0, 0.866666666667, 0.0591613474163),
                triggerBin(75.0, 0.756097560976, 0.0855764823779),
                triggerBin(80.0, 0.820512820513, 0.083232543249),
                triggerBin(90.0, 0.8, 0.100305789356),
        ...
        runs_190456_202585 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.714285714286, 0.0681708758749),
                triggerBin(65.0, 0.837837837838, 0.0842807841643),
                triggerBin(70.0, 0.851851851852, 0.101731447858),
                triggerBin(75.0, 0.6875, 0.156062611457),
                triggerBin(80.0, 0.833333333333, 0.179009937646),
                triggerBin(90.0, 0.8125, 0.149398565056),
        ...
        runs_190456_196531 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.796296296296, 0.0698882252153),
                triggerBin(65.0, 0.866666666667, 0.092936190246),
                triggerBin(70.0, 0.9, 0.116971358051),
                triggerBin(75.0, 0.583333333333, 0.183082685635),
                triggerBin(80.0, 0.888888888889, 0.211557930346),
                triggerBin(90.0, 0.909090909091, 0.179295209474),
        ...
        runs_190456_193621 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.777777777778, 0.221429368878),
                triggerBin(65.0, 1.0, 0.601684479424),
                triggerBin(70.0, 1.0, 0.841344746068),
                triggerBin(75.0, 0.333333333333, 0.414534706285),
                triggerBin(80.0, 1.0, 0.458641675296),
                triggerBin(90.0, 1.0, 0.458641675296), # duplicated bin
                triggerBin(100.0, 1.0, 0.458641675296), # duplicated bin
            ),
        ),
        # Run2012B
        runs_193833_196531 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.8, 0.0778410738914),
                triggerBin(65.0, 0.857142857143, 0.0986252499079),
                triggerBin(70.0, 0.894736842105, 0.122321715465),
                triggerBin(75.0, 0.666666666667, 0.22136076011),
        ...
        runs_198022_203742 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.555555555556, 0.213462824948),
                triggerBin(65.0, 0.714285714286, 0.259937875571),
                triggerBin(70.0, 0.714285714286, 0.259937875571),
                triggerBin(75.0, 1.0, 0.36887757085),
                triggerBin(80.0, 1.0, 0.458641675296),
                triggerBin(90.0, 0.6, 0.303366136254),
        ...
        runs_202807_208686 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.901639344262, 0.0541284567843),
                triggerBin(65.0, 0.875, 0.0878549422869),
                triggerBin(70.0, 0.882352941176, 0.134601457887),
                triggerBin(75.0, 0.833333333333, 0.135998901491),
                triggerBin(80.0, 0.823529411765, 0.142402653848),
                triggerBin(90.0, 0.777777777778, 0.221429368878),
    ...
    mcParameters = cms.PSet(
        Summer12_PU_2012ABCD = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.8, 0.157061286074),
                triggerBin(65.0, 1.0, 0.458641675296),
                triggerBin(70.0, 0.666666666667, 0.414534706285),
                triggerBin(75.0, 1.0, 0.36887757085),
                triggerBin(80.0, 1.0, 0.36887757085),
                triggerBin(90.0, 1.0, 0.841344746068),
                triggerBin(100.0, 0.9, 0.194135389638),
            ),
        ),
        Summer12_PU_2012ABC = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.851851851852, 0.101731447858),
                triggerBin(65.0, 1.0, 0.458641675296),
                triggerBin(70.0, 0.666666666667, 0.282023462085),
                triggerBin(75.0, 1.0, 0.308024223477),
                triggerBin(80.0, 1.0, 0.231260479746),
                triggerBin(90.0, 0.666666666667, 0.414534706285),
        ...
        Summer12_PU_2012AB = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(55.0, 0.9, 0.0877974084544),
                triggerBin(60.0, 0.875, 0.0878549422869),
                triggerBin(65.0, 0.666666666667, 0.414534706285),
                triggerBin(70.0, 0.857142857143, 0.257123832984),
                triggerBin(75.0, 1.0, 0.308024223477),
                triggerBin(80.0, 0.9, 0.194135389638),
                triggerBin(90.0, 1.0, 0.458641675296),
        ...
        Summer12_PU_2012A = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.588235294118, 0.149770451815),
                triggerBin(65.0, 1.0, 0.841344746068),
                triggerBin(70.0, 0.964285714286, 0.0773869563342),
                triggerBin(75.0, 1.0, 0.231260479746),
                triggerBin(80.0, 1.0, 0.0659132704298),
                triggerBin(90.0, 1.0, 0.132046423994),
        ...
        Summer12_PU_2012B = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(75.0, 1.0, 0.36887757085),
                triggerBin(80.0, 1.0, 0.231260479746),
                triggerBin(90.0, 0.5, 0.41724846474),
        ...
        Summer12_PU_2012C = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(65.0, 1.0, 0.458641675296),
                triggerBin(70.0, 0.75, 0.368402425504),
                triggerBin(75.0, 1.0, 0.308024223477),
                triggerBin(80.0, 1.0, 0.36887757085),
                triggerBin(90.0, 0.5, 0.41724846474),
        ...
        Summer12_PU_2012Unweighted = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.866666666667, 0.14953714223),
                triggerBin(65.0, 0.857142857143, 0.257123832984),
                triggerBin(70.0, 0.875, 0.23225032014),
                triggerBin(75.0, 1.0, 0.205567857429),
                triggerBin(80.0, 0.888888888889, 0.211557930346),
                triggerBin(90.0, 0.75, 0.368402425504),
    ...
    dataParameters = cms.PSet(
        ...
        runs_190456_208686 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.846153846154, 0.0362897555398),
                triggerBin(65.0, 0.853333333333, 0.0527553558263),
                triggerBin(70.0, 0.865384615385, 0.0649610897277),
                triggerBin(75.0, 0.75, 0.092985608778),
                triggerBin(80.0, 0.837837837838, 0.0842807841643),
                triggerBin(90.0, 0.821428571429, 0.102762023591),
        ...
        runs_190456_202585 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.736842105263, 0.0712453883203),
                triggerBin(65.0, 0.84375, 0.0918894448776),
                triggerBin(70.0, 0.869565217391, 0.11081369682),
                triggerBin(75.0, 0.6875, 0.156062611457),
                triggerBin(80.0, 0.833333333333, 0.179009937646),
                triggerBin(90.0, 0.866666666667, 0.14953714223),
                triggerBin(100.0, 0.916666666667, 0.166519597077),
            ),
        ),
        # Run2012A+B
        runs_190456_196531 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.816326530612, 0.0725145751455),
                triggerBin(65.0, 0.851851851852, 0.101731447858),
                triggerBin(70.0, 0.882352941176, 0.134601457887),
                triggerBin(75.0, 0.583333333333, 0.183082685635),
                triggerBin(80.0, 0.888888888889, 0.211557930346),
                triggerBin(90.0, 0.909090909091, 0.179295209474),
        ...
        runs_190456_193621 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.75, 0.239566802733),
                triggerBin(65.0, 1.0, 0.601684479424),
                triggerBin(80.0, 1.0, 0.458641675296),
                triggerBin(100.0, 0.0, 0.841344746068),
                triggerBin(80.0, 0.0, 0.841344746068), # duplicated bin
                triggerBin(90.0, 0.0, 0.841344746068), # duplicated bin
                triggerBin(100.0, 0.0, 0.841344746068), # duplicated bin
            ),
        ),
        # Run2012B
        runs_193833_196531 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.829268292683, 0.0798015918559),
                triggerBin(65.0, 0.84, 0.10854843784),
                triggerBin(70.0, 0.882352941176, 0.134601457887),
                triggerBin(75.0, 0.666666666667, 0.22136076011),
                triggerBin(80.0, 0.833333333333, 0.287350389332),
                triggerBin(90.0, 0.909090909091, 0.179295209474),
        ...
        runs_198022_203742 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(55.0, 0.857142857143, 0.257123832984),
                triggerBin(60.0, 0.5, 0.220457375638),
                triggerBin(65.0, 0.8, 0.324250626004),
                triggerBin(70.0, 0.833333333333, 0.287350389332),
                triggerBin(75.0, 1.0, 0.36887757085),
                triggerBin(80.0, 1.0, 0.458641675296),
                triggerBin(90.0, 0.75, 0.368402425504),
        ...
        runs_202807_208686 = cms.PSet(
            ...
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.925925925926, 0.054702793106),
                triggerBin(65.0, 0.884615384615, 0.0996453938308),
                triggerBin(70.0, 0.857142857143, 0.158270654649),
                triggerBin(75.0, 0.8125, 0.149398565056),
                triggerBin(80.0, 0.866666666667, 0.14953714223),
                triggerBin(90.0, 0.777777777778, 0.221429368878),
                triggerBin(100.0, 0.9, 0.194135389638),
            ),
        ),
    ...
    mcParameters = cms.PSet(
        Summer12_PU_2012ABCD = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.7, 0.20826248199),
                triggerBin(65.0, 1.0, 0.458641675296),
                triggerBin(70.0, 1.0, 0.601684479424),
                triggerBin(75.0, 1.0, 0.36887757085),
                triggerBin(80.0, 1.0, 0.36887757085),
                triggerBin(90.0, 1.0, 0.841344746068),
                triggerBin(100.0, 1.0, 0.18499249774),
        ...
        Summer12_PU_2012ABC = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.705882352941, 0.149968159557),
                triggerBin(65.0, 1.0, 0.458641675296),
                triggerBin(70.0, 1.0, 0.36887757085),
                triggerBin(75.0, 1.0, 0.308024223477),
        ...
        Summer12_PU_2012AB = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.75, 0.133747879731),
                triggerBin(65.0, 1.0, 0.601684479424),
        ...
        Summer12_PU_2012A = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.5, 0.150355854439),
                triggerBin(65.0, 1.0, 0.841344746068),
                triggerBin(70.0, 1.0, 0.0659132704298),
                triggerBin(75.0, 1.0, 0.231260479746),
                triggerBin(80.0, 1.0, 0.0659132704298),
                triggerBin(90.0, 1.0, 0.132046423994),
        ...
        Summer12_PU_2012B = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(60.0, 0.8, 0.130118869123),
                triggerBin(65.0, 1.0, 0.458641675296),
                triggerBin(70.0, 1.0, 0.601684479424),
                triggerBin(75.0, 1.0, 0.36887757085),
                triggerBin(80.0, 1.0, 0.26422943474),
        ...
        Summer12_PU_2012C = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(65.0, 1.0, 0.458641675296),
                triggerBin(70.0, 1.0, 0.458641675296),
                triggerBin(75.0, 1.0, 0.308024223477),
                triggerBin(80.0, 1.0, 0.36887757085),
                triggerBin(90.0, 0.5, 0.41724846474),
        ...
        Summer12_PU_2012Unweighted = cms.PSet(
            bins = cms.VPSet(
                ...
                triggerBin(55.0, 0.9, 0.0877974084544),
                triggerBin(60.0, 0.846153846154, 0.16803608658),
                triggerBin(65.0, 1.0, 0.308024223477),
